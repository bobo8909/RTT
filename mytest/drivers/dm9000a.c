...
static void RCC_Configuration(void)
{
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOF | RCC_APB2Periph_GPIOE | RCC_APB2Periph_AFIO, ENABLE);
}
...
static void GPIO_Configuration()
{
    ...
    EXTI_InitStructure.EXTI_Trigger = EXTI_Trigger_Falling;// 低电平有效 EXTI_Trigger_Rising 
